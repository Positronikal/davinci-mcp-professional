...
def get_resolve_paths() -> Dict[str, Path]:
    ...
    if current_platform == "macos":
        ...
        lib_path = Path("/Applications/DaVinci Resolve/DaVinci Resolve.app/Contents/Libraries/Fusion/fusionscript.so")
    
    elif current_platform == "windows":
        program_data = Path(os.environ.get("PROGRAMDATA", "C:\\ProgramData"))
        program_files = Path(os.environ.get("PROGRAMFILES", "C:\\Program Files"))
        
        api_path = program_data / "Blackmagic Design" / "DaVinci Resolve" / "Support" / "Developer" / "Scripting"
        lib_path = program_files / "Blackmagic Design" / "DaVinci Resolve" / "fusionscript.dll"
